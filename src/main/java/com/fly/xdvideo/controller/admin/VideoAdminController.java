...
public class VideoAdminController {
    ...
    @PutMapping("/update")
    public void updateVideoById(@RequestBody Video video){
    ...
    public Object saveVideo(@RequestParam("title")String title){
    ...
    public void deleteVideoById(@RequestParam(value = "id",required = true)Integer id){
